...
Lets start building the chat screen, for chat we need messages, we will create a model for messages , Create a new 📄 file under models 📁 folder  => **`message.dart`**
...
We will create some dummy data to work with , update 📄 file **data.dart** under data 📁 folder ,  will create some dummy users and messages
...
To test update main.dart 📄 file and point home to the new **chat_screen**

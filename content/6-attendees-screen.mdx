...
First create database_service to call firestore database and retrieve users Create a new 📄 file under **services** 📁 folder  => database_service.dart 📄 file 
...
create a new model to hold user_data -> Create a new file user_data.dart under models
...
We will use provider to maintain state within app. 
...
modify home and add routes for mavigation

...
stepNo: 2
metaTitle: Flutter chat codelab - Project Structure page
metaDescription: Flutter chat codelab - Project Structure page description
...
The last thing to note is how we imported the **images** into our app. If we go into a **pubspec.yaml** 📄 file  if we scroll down to assets all I did was uncomment.
